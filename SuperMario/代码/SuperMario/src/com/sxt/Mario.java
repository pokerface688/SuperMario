...
public class Mario implements Runnable{
    ...
    public void jump() {
        if (status.indexOf("jump") == -1) {
            new gameMusic(System.getProperty("user.dir") + "/src/Music/跳.mp3").start();
        ...
        while (true) {
            ...
            if (backGround.isFlag() && this.x >= 500) {
                ...
                for (int i = 0; i < backGround.getObstacleList().size(); i++) {
                    ...
                    //判断马里奥是否位于障碍物上
                    if (ob.getY() == this.y + 25 && (ob.getX() > this.x - 31 && ob.getX() < this.x + 25)) {
                        onObstacle = true;
                    }
                    ...
                    if ((ob.getY() >= this.y - 30 && ob.getY() <= this.y - 20) && (ob.getX() > this.x - 30 && ob.getX() < this.x + 25)) {
                        if (ob.getType() == 0) {
                            ...
                            new gameMusic(System.getProperty("user.dir") + "/src/Music/顶破砖.mp3").start();
                            score += 1;
                        }
                        upTime = 0;
                    }
                    ...
                    if((!onObstacle)&&(ob.getX() == this.x + 25) && (ob.getY() >= this.y - 30 && ob.getY() <= this.y + 25)){
                        canRight = false;
                    }
                    ...
                    if((!onObstacle)&&(ob.getX() == this.x - 30) && (ob.getY() >= this.y - 30 && ob.getY() <= this.y + 25)){
                        canLeft = false;
                    }
